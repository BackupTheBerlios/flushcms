 ...
 *
 *   $Id: lang_bbcode.php,v 1.1 2006/11/20 08:46:28 arzen Exp $
 *
 *
 ***************************************************************************/
...
//
//      For questions and comments use: support@cnphpbb.com
//       最后更新 2003-01-17                     
//
...
$faq[] = array("--", "隐藏内容介绍");
$faq[] = array("在隐藏帖子中加入内容简介", "这一功能是为了配合隐藏帖子内容。如果您发帖时指定了一种隐藏帖子的方式，通常来说其他用户在达到您所指定的要求时是不能看到这个帖子的任何内容的。而无论其他会员是否有权查看您的帖子的正文，在[intro][/intro]标签内的内容都可以显示出来。比如当您想出售一个帖子时，可以用这一方法给用户显示一些相关信息，以利于会员决定是否购买您的帖子。本标签的使用很简单，只要把您想显示的内容写在[intro]与[/intro]之间即可。");
