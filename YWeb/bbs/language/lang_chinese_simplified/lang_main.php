 ...
 *
 *     $Id: lang_main.php,v 1.1 2006/11/20 08:46:28 arzen Exp $
 *
 ****************************************************************************/
...
// please add it here.
$lang['TRANSLATION_INFO'] = '<a target="_blank" href="http://www.cnphpbb.com">phpBB中文开发小组</a>提供技术支持';
...
$lang['Board_disable_access'] = '<font color="red"><b>论坛关闭。您拥有访问权。</b></font>';
...
$lang['No_topics_post_one'] = '这个论坛里还没有文章<br />点击<b>发表新帖</b>发表第一篇文章';
...
$lang['Sticky_topic'] = '置顶主题';
$lang['Announce_topic'] = '设为公告';
$lang['Normal_topic'] = '普通主题';
...
$lang['Total_votes'] = '总投票数: '; 
$lang['Voted_show'] = '投票人数: '; // it means :  users that voted  (the number of voters will follow) 
$lang['Results_after'] = '投票结果将在投票截止后可见。'; 
$lang['Poll_expires'] = '投票截止还有 '; 
$lang['Poll_expiredyes'] = '- 投票已经截止 -'; 
$lang['Poll_noexpire'] = '[ 这个投票没有截止期限 ]'; 
$lang['Minutes'] = '分';
//
...
$lang['Poll_for_explain'] = '[选择 0 或者不选择这个选项表示投票永远有效]';
$lang['Delete_poll'] = '删除投票';
$lang['Max_vote'] = '最多可选数'; 
$lang['Max_vote_explain'] = '<br>[ 输入 1 或是空白, 表示只允许选一项。]'; 
$lang['Max_voting_1_explain'] = '您最多只可以选择 '; 
$lang['Max_voting_2_explain'] = ' 个答案'; 
$lang['Max_voting_3_explain'] = '（超过限制的选择，将被忽略。）'; 
$lang['Vhide'] = '隐藏'; 
$lang['Hide_vote'] = '投票结果'; 
$lang['Tothide_vote'] = '投票总数'; 
$lang['Hide_vote_explain'] = '<br>[ 隐藏，直到投票截止。 ]'; 
...
$lang['bbcode_y_help'] = '隐藏内容介绍: [intro]text[/intro]';
//
...
//
$lang['bbcode_help']['value'] = 'BBCode 名字: 信息 (Alt+%s)';
...
$lang['This_closed_group'] = '这是一个关闭的团队：%s';
$lang['This_hidden_group'] = '这是一个隐藏的团队：%s';
$lang['Member_this_group'] = '您是这个团队的成员';
$lang['Pending_this_group'] = '您的申请正在审核中';
$lang['Are_group_moderator'] = '您是团队管理员';
$lang['None'] = '无';
$lang['No_more'] = '不接受新的成员';
$lang['No_add_allowed'] = '不允许自动增加成员';
$lang['Join_auto'] = '当你的发贴数达到团队要求的时候将会加入这个团队';
...
$lang['Search_Flood_Error'] = '搜索时间间隔限制，请稍后再试！';
...
// Viewonline
//
$lang['Reg_users_zero_online'] = "现在有 0 位注册会员和 "; // There ae 5 Registered and
$lang['Reg_users_online'] = "现在有 %d 位注册会员和 "; // There ae 5 Registered and
$lang['Reg_user_online'] = "现在有 %d 位注册会员和 "; // There ae 5 Registered and
$lang['Hidden_users_zero_online'] = "0 位隐身会员"; // 6 Hidden users online
$lang['Hidden_users_online'] = "%d 位隐身会员在线"; // 6 Hidden users online
$lang['Hidden_user_online'] = "%d 位隐身会员在线"; // 6 Hidden users online
$lang['Guest_users_online'] = "现在有 %d 位游客在线"; // There are 10 Guest users online
$lang['Guest_users_zero_online'] = "现在有 0 位游客在线"; // There are 10 Guest users online
$lang['Guest_user_online'] = "现在有 %d 位游客在线"; // There is 1 Guest user online
$lang['No_users_browsing'] = "现在没有用户在这个论坛浏览";
$lang['Online_explain'] = '这是过去' . $board_config['who_is_online_time'] . '分钟内的论坛在线情况';
...
$lang['Topics_Stickyd'] = '选择的主题已置顶';
$lang['Topics_Announced'] = '选择的主题已设为公告';
$lang['Topics_Normalised'] = '选择的主题已恢复为普通贴';
...
$lang['Admin_reauthenticate'] = '访问管理员控制面板必须重新进行登录验证';

// SQR
$lang['Quick_reply_panel'] = '快速回复Mod';
$lang['Quick_Reply'] = '快速回复';
$lang['Show_quick_reply'] = '显示快速回复表单';
$lang['sqr']['0'] = '否';
$lang['sqr']['1'] = '是';
$lang['sqr']['2'] = '显示在最后一页';
$lang['Quick_reply_mode'] = '快速回复模式';
$lang['Quick_reply_mode_basic'] = '基本';
$lang['Quick_reply_mode_advanced'] = '高级';
$lang['Show_hide_quick_reply_form'] = '显示/隐藏快速回复表单';
$lang['Open_quick_reply'] = '自动打开快速回复表单';

//Fav Mod
$lang['remove_fav_data'] = '无法从收藏夹数据表中移除数据';
$lang['insert_fav_data'] = '无法将数据插入收藏夹数据表';
$lang['no_fav_topic'] = '收藏夹中没有帖子';
$lang['favorites'] = '收藏夹';
$lang['add_fav'] = '加入收藏夹';

// TOPIC SEARCH MOD
$lang['Click_return_topic'] = '点击%s这里%s返回主题';
$lang['No_search_words'] = '抱歉, 没有填写搜索字串';
$lang['Search_topic'] = '搜索主题';
$lang['Jump_to_post'] = '跳转到此帖';
...
$lang['is_offline'] = '%s离线';
$lang['is_hidden'] = '%s隐身';
$lang['Online_status'] = '状态';

// Yellow card admin MOD
$lang['Give_G_card']='重新激活会员'; 
$lang['Give_Y_card']='给会员发送警告#%d次'; 
$lang['Give_R_card']='立即禁止此会员'; 
$lang['Ban_update_sucessful'] = '禁止名单已成功更新'; 
$lang['Ban_update_green'] = '会员现已重新激活'; 
$lang['Ban_update_yellow'] = '此会员已收到一个警告, 现在已有总数为%d次警告，最高限为%d次警告'; 
$lang['Ban_update_red'] = '会员已被禁止'; 
$lang['Ban_reactivate'] = '您的帐号已被重新激活'; 
$lang['Ban_warning'] = '您收到一个警告'; 
$lang['Ban_blocked'] = '您的帐号已被禁止'; 
$lang['Click_return_viewtopic'] = '点击 %s这里%s 返回主题'; 
$lang['Rules_ban_can'] = '您<b>可以</b>在此论坛中禁止其他会员'; 
$lang['user_no_email'] = '此会员有有填写email, 因此不会发送此操作的信息. 您可以通过站内短信的方式提示'; 
$lang['user_already_banned'] = '被选中的会员已被禁止'; 
$lang['Ban_no_admin'] ='此会员是管理员，因此不能警告或禁止'; 
$lang['Rules_greencard_can'] = '您<b>可以</b>在此论坛中将会员取消禁止'; 
$lang['Rules_bluecard_can'] = '您可以<b>可以</b>报告帖子给本论坛版主'; 
$lang['Give_b_card'] = '报告此帖给本论坛的版主'; 
$lang['Clear_b_card'] = '此帖已有%d张蓝牌. 如果您按下此按钮将清除这些蓝牌'; 
$lang['No_moderators'] = '本论坛没有版主, 没有发送报告!'; 
$lang['Post_repported'] = '此帖现已被报告给%d个版主'; 
$lang['Post_repported_1'] = '此帖已被报告给版主'; 
$lang['Post_repport'] = '报告帖子'; //Subject in email notification
$lang['Post_reset'] = '此主题的蓝牌已被重置'; 
$lang['Search_only_bluecards'] = '只搜索含有蓝牌的主题';
$lang['Send_message'] = '点击%s这里%s写一个信息给版主或 <br />';
$lang['Send_PM_user'] = '点击%s这里%s写一个站内短信给会员或者';
$lang['Link_to_post'] = '点击%s这里%s转到报告帖子  <br/>--------------------------------<br/><br/>';
$lang['Post_a_report'] = '提交帖子报告';
$lang['Report_stored'] = '您的报告已输入成功';
$lang['Send_report'] = '点击%s这里%s返回最初的信息';
$lang['Red_card_warning'] = '您将给会员:%s一张红牌, 此将会禁止此会员, 确定吗?'; 
$lang['Yellow_card_warning'] = '您将给会员:%s一张黄牌, 警告一下此会员, 确定吗?'; 
$lang['Green_card_warning'] = '您将给会员:%s一张绿牌, 此将会取消禁止此会员,确定吗?'; 
$lang['Blue_card_warning'] = '您将给此帖一张蓝牌, 提醒版主注意此帖, 确定吗?'; 
$lang['Clear_blue_card_warning'] = '您将重置此帖的蓝牌数, 继续吗?';
$lang['Warnings'] = '警告次数: %d'; //shown beside users post, if any warnings given to the user
$lang['Banned'] = '现已禁止';//shown beside users post, if user are banned

// Global announcement MOD
$lang['Topic_global_announcement']='<b>论坛通告:</b>'; 
$lang['Post_global_announcement'] = '论坛通告';

// Birthday MOD
$lang['Birthday'] = '生日'; 
$lang['No_birthday_specify'] = '不填写'; 
$lang['Age'] = '年龄'; 
$lang['Birthday_explain'] = '格式是 %s, 例如 %s, 注意前面要加0'; 
$lang['Wrong_birthday_format'] = '您输入的生日格式不正确.'; 
$lang['Birthday_to_high'] = '对不起，这个网站不接受年龄大于%d的用户';
$lang['Birthday_to_low'] = '对不起，这个网站不接受年龄小于%d的用户';
...
$lang['Birthday_greeting_today'] ='祝贺您，今天是您的 %s 岁生日.<br /><br /> 论坛管理团队';//%s is substituted with the users age 
$lang['Birthday_greeting_prev'] ='恭喜、恭喜，%s岁大的你，%s是你的生日，请接受这份迟到的祝福。<br /><br /> 一会儿看一看';//%s is substituted with the users age, and birthday 
$lang['Greeting_Messaging'] ='祝贺'; 
$lang ['Birthday_today'] = '今天生日的会员:'; 
$lang ['Birthday_week'] = '未来 %d 天生日的会员:'; 
$lang ['Nobirthday_week'] = '没有会员在未来的%d 天内生日'; // %d is substitude with the number of days 
$lang ['Nobirthday_today']='今天没有会员生日'; 
$lang['Year'] = '年'; 
$lang['Month'] = '月'; 
$lang['Day'] = '日';
...
// Gender MOD
$lang['Gender'] = '性别';//used in users profile to display witch gender he/she is 
$lang['Male'] = '男'; 
$lang['Female']='女'; 
$lang['No_gender_specify'] = '保密'; 

$lang['Email_disabled'] = '电子邮件功能已经被论坛禁用! 请将您要做的事情告知管理员以获得关于这个错误的更多情况'; 
$lang['Email_disabled_send_password'] = '电子邮件功能已经被论坛禁用! 如果你想要找回密码，请联系%s管理员%s';
$lang['Check_All'] = '全选';
$lang['Uncheck_All'] = '全取消';
$lang['Topic_Commend'] = '<b>精华:</b>';
$lang['Commend_topic'] = '精华主题';
$lang['Post_Commend'] = '精华';
$lang['New_Commend'] = '有新文章 [ 精华 ]';
$lang['No_New_Commend'] = '没有新文章 [ 精华 ]';
$lang['Sorry_auth_commend'] = '抱歉! 只有 %s 可以在这个版面发表精华文章';
$lang['Topics_Commended'] = '选择的主题已设为精华主题';
$lang['Commend'] = '精华区';
$lang['Forum_commend'] = '观看本版的精华主题';

$lang['Word_language'] = '语言';
$lang['Forum_sub'] = '子版面';
$lang['Group_owner'] = '团队所有者';
$lang['Group_grant_mod_status'] = '授权/取消管理员权限';
$lang['Group_grant_ungrant_mod_ok'] = '这个团队的管理员列表已经更新';
$lang['Board_Disbale_MSG'] = '对不起，论坛暂时无法访问。请稍后再试。';
$lang['Estimated_Downtime'] = '预计关闭时间：~';
$lang['Notes'] = '说明：';

$lang['Login_attempts_exceeded'] = '已经达到了最大登陆尝试次数 %s 。您在未来的 %s 分钟内将不允许使用登陆功能。';
$lang['Please_remove_install_contrib'] = '请确定您已经删除了 install/ 和 contrib/ 目录';
//
// That's all, Folks!
// -------------------------------------------------
?>