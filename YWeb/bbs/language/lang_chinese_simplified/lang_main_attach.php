...
* @version $Id: lang_main_attach.php,v 1.1 2006/11/20 08:46:28 arzen Exp $
...
$lang['Rules_attach_can'] = '您<b>可以</b>在这个论坛添加附件';
$lang['Rules_attach_cannot'] = '您<b>不能</b>在这个论坛添加附件';
$lang['Rules_download_can'] = '您<b>可以</b>在这个论坛下载文件';
$lang['Rules_download_cannot'] = '您<b>不能</b>在这个论坛下载文件';
...
$lang['Download'] = '下载'; // this Language Variable is defined in lang_admin.php too, but we are unable to access it from the main Language File
$lang['Filesize'] = '文件大小';
$lang['Viewed'] = '看过的';
$lang['Download_number'] = '文件被下载或查看 %d 次'; // replace %d with count
$lang['Extension_disabled_after_posting'] = '扩展名 \'%s\' 已被系统管理员停用，因此这个附件是不被显示的。'; // used in Posts and PM's, replace %s with mime type
...
$lang['Allowed_extensions_and_sizes'] = '允许的扩展名和大小';
