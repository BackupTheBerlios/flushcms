...
$lang['Search_Flood_Interval'] = '搜索间隔时间限制';
$lang['Search_Flood_Interval_explain'] = '一个用户两次搜索请求之间间隔的时间（秒）'; 
...
$lang['Confirm_delete_smiley'] = '您确定要删除这个表情符号？';
...
$lang['Confirm_delete_word'] = '您确定要删除这个过滤文字？';
...
$lang['No_update_ranks'] = '等级已经成功删除，但是使用本等级的用户帐号尚未更新。您需要手动重置这些帐号。';

$lang['Click_return_rankadmin'] = '点击%s这里%s返回等级管理';
$lang['Confirm_delete_rank'] = '您确定要删除这个等级？';
