 ...
 *
 *   $Id: usercp_viewprofile.php,v 1.1 2006/11/20 08:46:27 arzen Exp $
 *
 *
 ***************************************************************************/
...
$aim_img = ( $profiledata['user_aim'] ) ? '<a href="http://friend.qq.com/cgi-bin/friend/user_show_info?ln=' . $profiledata['user_aim'] . '" target="_blank"><img src="' . $php_install_url . $images['icon_aim'] . '" alt="' . $lang['AIM'] .':'. $profiledata['user_aim'] . '" title="' . $lang['AIM'] .':'. $profiledata['user_aim'] . '" border="0" /></a>' : '';
$aim = ( $profiledata['user_aim'] ) ? '<a href="http://friend.qq.com/cgi-bin/friend/user_show_info?ln=' . $profiledata['user_aim'] . '" target="_blank">' . $lang['AIM'] . $profiledata['user_aim'] . '</a>' : '';
