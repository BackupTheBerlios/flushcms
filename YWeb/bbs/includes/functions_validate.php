 ...
 *
 *   $Id: functions_validate.php,v 1.1 2006/11/20 08:46:27 arzen Exp $
 *
 *
 ***************************************************************************/
...
//
function validate_optional_fields(&$icq, &$aim, &$msnm, &$yim, &$skype, &$website, &$location, &$occupation, &$interests, &$sig)
{
