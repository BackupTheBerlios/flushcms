 ...
 *                                                          
 *   $Id: auth.php,v 1.1 2006/11/20 08:46:27 arzen Exp $                                                           
 *                                                            
 * 
 ***************************************************************************/ 
...
function auth($type, $forum_id, $userdata, $f_access = '')
{
	...
	{
		case AUTH_ALL:
			$a_sql = 'a.auth_view, a.auth_read, a.auth_post, a.auth_reply, a.auth_edit, a.auth_delete, a.auth_sticky, a.auth_announce, a.auth_commend, a.auth_vote, a.auth_pollcreate, a.auth_sellpost, a.auth_hide4reply, a.auth_hide4posts, a.auth_hide4fortune, a.auth_ban, a.auth_greencard, a.auth_bluecard, a.auth_globalannounce';
			$auth_fields = array('auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_delete', 'auth_sticky', 'auth_announce', 'auth_commend', 'auth_vote', 'auth_pollcreate', 'auth_sellpost', 'auth_hide4reply', 'auth_hide4posts', 'auth_hide4fortune', 'auth_ban', 'auth_greencard', 'auth_bluecard', 'auth_globalannounce');
			break;
		...
		case AUTH_STICKY:
			...
			break;
		case AUTH_COMMEND:
			$a_sql = 'a.auth_commend';
			$auth_fields = array('auth_commend');
			break;
