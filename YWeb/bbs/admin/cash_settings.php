 ...
 *   email                : mods@xore.ca
 *
 *   $Id: cash_settings.php,v 1.1 2006/11/20 08:46:28 arzen Exp $
 *
 *
 ***************************************************************************/
...
$update_set = array(CURRENCY_ENABLED => 'bool',
					...
					'cash_allowance' => 'int',			'cash_allowanceamount' => 'float',	'cash_allowancetime' => 'int',		'cash_max_sellingprice' => 'float',	'cash_min_sellingprice' => 'float',	'cash_max_fortunerequired' => 'float',			'cash_min_fortunerequired' => 'float');
...
$template->assign_vars(array(
	...
	"L_MAX_PRICE_EXPLAIN" => $lang['Cash_max_price_explain'],
	"L_MIN_SELLINGPRICE" => $lang['Min_sellingprice'],
	"L_MIN_PRICE_EXPLAIN" => $lang['Cash_min_price_explain'],
	"L_MAX_FORTUNEREQUIRED" => $lang['Max_fortune_required'],
	"L_MAX_FORTUNE_EXPLAIN" => $lang['Cash_max_fortune_explain'],
	"L_MIN_FORTUNEREQUIRED" => $lang['Min_fortune_required'],
	"L_MIN_FORTUNE_EXPLAIN" => $lang['Cash_min_fortune_explain'],
