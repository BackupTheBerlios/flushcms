...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr> 
	<td align="center" rowspan="2"> {FORUM_ICON} </td>
  </tr>
  <tr> 
	<td align="left" width="100%" valign="bottom" colspan="2"><a class="maintitle" href="{U_VIEW_TOPIC}">{TOPIC_TITLE}</a><br />
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
	...
	<!-- BEGIN postrow -->
	<tr> 
		<td width="150" align="left" valign="top" class="{postrow.ROW_CLASS}"><span class="name"><a name="{postrow.U_POST_ID}"></a><b>{postrow.POSTER_NAME}</b><br />{postrow.CARD_IMG}</span><br /><span class="postdetails">{postrow.POSTER_RANK}<br />{postrow.RANK_IMAGE}{postrow.POSTER_AVATAR}<br /><br />{postrow.POSTER_GENDER}<br />{postrow.POSTER_AGE}<br />{postrow.POSTER_JOINED}<br />{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}<br />{postrow.CASH}</span><br /></td>
...
<!-- End add - Yellow card admin MOD -->
			...
			<tr>
				<td colspan="2">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;word-wrap: break-word;word-break:break-all;">
					  <tr>
					    <td><span class="postbody">{postrow.MESSAGE}</span>{postrow.ATTACHMENTS}<span class="postbody">{postrow.HIDING_INFO_BOX}{postrow.SIGNATURE}</span><span class="gensmall">{postrow.EDITED_MESSAGE}</span></td>
					  </tr>
					</table>
				</td>
			</tr>
	...
	<tr> 
		...
		<td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="bottom" nowrap="nowrap"><table cellspacing="0" cellpadding="0" border="0" height="18" width="18">
			<tr> 
				<td valign="middle" nowrap="nowrap">{postrow.PROFILE_IMG} {postrow.POSTER_ONLINE_STATUS_IMG} {postrow.PM_IMG} {postrow.EMAIL_IMG} {postrow.WWW_IMG} {postrow.AIM_IMG} {postrow.YIM_IMG} {postrow.MSN_IMG} {postrow.SKYPE_IMG}<script language="JavaScript" type="text/javascript"><!-- 
...
<br /><span class="gensmall"><a href="{U_FAV}">{L_FAV}</a></span><br />
