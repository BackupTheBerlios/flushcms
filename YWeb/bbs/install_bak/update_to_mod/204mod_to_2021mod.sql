DROP TABLE phpbb_friendlinks;
TRUNCATE phpbb_themes;
TRUNCATE phpbb_themes_name;

DELETE FROM phpbb_config WHERE config_name='points_reply' LIMIT 1;
DELETE FROM phpbb_config WHERE config_name='points_topic' LIMIT 1;
DELETE FROM phpbb_config WHERE config_name='points_post' LIMIT 1;
DELETE FROM phpbb_config WHERE config_name='points_donate' LIMIT 1;
...
ALTER TABLE phpbb_attachments ADD INDEX ( post_id );
ALTER TABLE phpbb_attachments ADD INDEX ( privmsgs_id );
...
ALTER TABLE phpbb_cash ADD cash_max_sellingprice INT DEFAULT '0' NOT NULL;
ALTER TABLE phpbb_cash ADD cash_min_sellingprice INT DEFAULT '1' NOT NULL;
ALTER TABLE phpbb_cash ADD cash_max_fortunerequired INT DEFAULT '0' NOT NULL;
ALTER TABLE phpbb_cash ADD cash_min_fortunerequired INT DEFAULT '1' NOT NULL;

ALTER TABLE phpbb_users ADD user_warnings SMALLINT(5) DEFAULT '0';
ALTER TABLE phpbb_users ADD user_show_quickreply  TINYINT(1) DEFAULT '1';
ALTER TABLE phpbb_users ADD user_quickreply_mode TINYINT(1) DEFAULT '1';
...
ALTER TABLE phpbb_users CHANGE user_timezone user_timezone DECIMAL(5, 2) DEFAULT '0.00' NOT NULL;
ALTER TABLE phpbb_users CHANGE user_level user_level TINYINT(4) DEFAULT '0';
ALTER TABLE phpbb_users CHANGE user_rank user_rank INT(11) DEFAULT '0';
ALTER TABLE phpbb_users CHANGE user_points user_points DECIMAL(11, 0) DEFAULT '0' NOT NULL;
...
ALTER TABLE phpbb_forum_prune CHANGE prune_days prune_days SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE phpbb_forum_prune CHANGE prune_freq prune_freq SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL;
...
ALTER TABLE phpbb_privmsgs CHANGE privmsgs_subject privmsgs_subject VARCHAR( 255 ) DEFAULT '0' NOT NULL;

ALTER TABLE phpbb_privmsgs_text CHANGE privmsgs_bbcode_uid privmsgs_bbcode_uid VARCHAR( 10 ) DEFAULT '0' NOT NULL;

ALTER TABLE phpbb_quota_limits CHANGE quota_limit quota_limit BIGINT( 20 ) UNSIGNED DEFAULT '0' NOT NULL;

ALTER TABLE phpbb_ranks CHANGE rank_special rank_special TINYINT( 1 ) DEFAULT '0';

ALTER TABLE phpbb_sessions CHANGE session_ip session_ip CHAR( 8 ) DEFAULT '0' NOT NULL;
...
UPDATE phpbb_config SET config_value = '谢谢您的阅读, 论坛管理团队' WHERE config_name = 'board_email_sig' LIMIT 1;
UPDATE phpbb_config SET config_value = '积分' WHERE config_name = 'points_name' LIMIT 1;
