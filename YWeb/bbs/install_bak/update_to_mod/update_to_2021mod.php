...
if($step==2)
{
	$sqlfiles[0]="204mod_to_2021mod.sql";
	$sqlfiles[1]="206mod_to_2021mod.sql";
	$sqlfiles[2]="2011mod_to_2021mod.sql";
	$sqlfiles[3]="2012-14mod_to_2021mod.sql";
	$sqlfiles[4]="2015mod_to_2021mod.sql";
	$sqlfiles[5]="2016mod_to_2021mod.sql";
	$sqlfiles[6]="2017mod_to_2021mod.sql";
	$sqlfiles[7]="2018mod_to_2021mod.sql";
	$sqlfiles[8]="2019mod_to_2021mod.sql";
	$sqlfiles[9]="2020mod_to_2021mod.sql";
	$sqlfiles[10]="2021_to_2021mod.sql";
	...
	<tr>
		<td class="bodyline" width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="center" width="100%" valign="middle"><span class="maintitle">Update to CNphpBB 2.0.21 MOD </span></td>
					</tr>
				</table></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<table width="100%" align="center" cellpadding="2" cellspacing="1" border="0" class="forumline">
				  ...
				  <tr>
				    <td align="center" class="catBottom">
					  <input class="mainoption" type="submit" name="bt0" value="确定要升级" onClick="location='update_to_2021mod.php?step=1';">	</td>
				  </tr>
				  </form>
				</table>
				<?
				...
				?>
				<table width="100%" align="center" cellpadding="2" cellspacing="1" border="0" class="forumline">
				  <form action="update_to_2021mod.php" name="form" method="post">
				    ...
				    <tr>
				      ...
				      <td class="row2">
						  ...
						  <option value="8"><span class="gen">由CNphpBB2.0.19mod升级</span></option>
						  <option value="9"><span class="gen">由CNphpBB2.0.20mod升级</span></option>
						  <option value="10"><span class="gen">由phpBB2.0.21标准版升级</span></option>
						</select></td>
				    </tr>
				    <tr>
				    ...
				    <td height="24" class="row1"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
				        ...
				        <tr>
			              ...
			              <p>数据库升级完毕！请用户自行进行下面的步骤：</p>
				            ...
				            <p>上传2.0.21mod标准版。<font color="#FF0000">注意：</font>不要上传install和contrib这两个文件夹及其内部的文件，不要上传config.php!</p>
				            <p>打开论坛检查数据库升级是否完成，使用管理员控制面板修改论坛设置</p>
				            <p>最后，不要忘了删除update_to_2021mod.php和20*_to_2021mod.sql</p>
				          </span></td>
				        </tr>
				        <tr>
				          <td>&nbsp;</td>
