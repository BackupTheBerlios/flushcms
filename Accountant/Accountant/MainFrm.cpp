	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(200, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CAccountantView), CSize(100, 100), pContext))
	{
...
CAccountantView* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CAccountantView* pView = DYNAMIC_DOWNCAST(CAccountantView, pWnd);
	return pView;
}
