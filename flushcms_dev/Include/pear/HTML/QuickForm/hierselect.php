...
// +----------------------------------------------------------------------+
//
// $Id: hierselect.php,v 1.1 2005/12/11 14:53:41 arzen Exp $

require_once(PEAR_DIR.'HTML/QuickForm/group.php');
...
JAVASCRIPT;
        ...
        include_once(PEAR_DIR.'HTML/QuickForm/Renderer/Default.php');
