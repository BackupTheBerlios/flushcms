...
/*
   ...
   +----------------------------------------------------------------------+
   | Author: John.meng(ÃÏÔ¶òû)  2005-12-2 7:33:56                        
   +----------------------------------------------------------------------+
 */
 
/* $Id: Mail.class.php,v 1.1 2005/12/08 08:52:35 arzen Exp $ */
...
class Mail
{
	...
	*/
	...
	function Body($body, $charset = "gb2312")
	{
		$this->body = $body;
		if ($charset != "")
		{
