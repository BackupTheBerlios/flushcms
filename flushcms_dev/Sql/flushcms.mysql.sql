...
INSERT INTO site_news VALUES (3,6,'en-us','Smarty 2.6.10 Released','This release addresses some minor bug fixes and feature enhancements. Most notable are the secure_dir setting can now be a filename as well as a directory name, more strict syntax checking for quoted strings in the templates, and removal of an ambiguity w','This release addresses some minor bug fixes and feature enhancements. Most notable are the secure_dir setting can now be a filename as well as a directory name, more strict syntax checking for quoted strings in the templates, and removal of an ambiguity with numerical date_format values. See the change log for the entire list. CCCC','Smarty','Smarty','2006-01-22 13:58:23','127.0.0.1');
INSERT INTO site_news VALUES (4,2,'en-us','PHP turns 10','Yesterday was the 10th anniversary of the inception of PHP onto the programming world. The Smarty developers send their congrats to Rasmus and the literally thousands of developers who have made it into what it is today. Smarty itself is over four','Yesterday was the <A href=\"http://www.phpdeveloper.org/index/3223\"><U><FONT color=#0000ff>10th anniversary</FONT></U></A> of the inception of PHP onto the programming world. The Smarty developers send their congrats to Rasmus and the literally thousands of developers who have made it into what it is today. Smarty itself is over four years old now, which was introduced on January 18th, 2001. GDSAFDSAF','Smarty','Smarty','2006-01-22 13:57:59','127.0.0.1');
