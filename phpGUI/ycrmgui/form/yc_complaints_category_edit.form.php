...
if(!defined('IDC_UPDATE')) define('IDC_UPDATE', 2671);
if(!defined('IDC_SAVE')) define('IDC_SAVE', 2672);
if(!defined('IDC_CATEGORY_NAME')) define('IDC_CATEGORY_NAME', 2673);

// Create window

$winmain = wb_create_window($wb->mainwin, ModalDialog, "{$wb->vars["Lang"]["lang_complaints"]}{$wb->vars["Lang"]["lang_category"]}", WBC_CENTER, WBC_CENTER, 370, 160, 0x00000000, 0);
