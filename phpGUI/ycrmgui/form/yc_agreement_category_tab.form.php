...
if(!defined('IDC_AGREEMENT_CATEGORY_LIST')) define('IDC_AGREEMENT_CATEGORY_LIST', 2201);
if(!defined('IDC_CATEGORY_NAV_FIRST')) define('IDC_CATEGORY_NAV_FIRST', 2202);
if(!defined('IDC_CATEGORY_NAV_PRE')) define('IDC_CATEGORY_NAV_PRE', 2203);
if(!defined('IDC_CATEGORY_NAV_NEXT')) define('IDC_CATEGORY_NAV_NEXT', 2204);
if(!defined('IDC_CATEGORY_NAV_LAST')) define('IDC_CATEGORY_NAV_LAST', 2205);
if(!defined('IDC_CATEGORY_NAV_BAR')) define('IDC_CATEGORY_NAV_BAR', 2206);

// Insert controls

wb_create_control($maintab, ListView, "Head1,Head2,Head3,Head4", 0, 10, 625, 425, IDC_AGREEMENT_CATEGORY_LIST, 0x00050080, 0, 1);
