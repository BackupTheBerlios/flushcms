...
if(!defined('IDC_CONTACT_USERNAME')) define('IDC_CONTACT_USERNAME', 1371);
if(!defined('IDC_GENDER_MALE')) define('IDC_GENDER_MALE', 1372);
if(!defined('IDC_GENDER_FEMALE')) define('IDC_GENDER_FEMALE', 1373);
if(!defined('IDC_CONTACT_SAVE')) define('IDC_CONTACT_SAVE', 1374);
if(!defined('IDC_CONTACT_BIRTHDAY')) define('IDC_CONTACT_BIRTHDAY', 1375);
if(!defined('IDC_CONTACT_ADDREES')) define('IDC_CONTACT_ADDREES', 1376);
if(!defined('IDC_CONTACT_OFFICEPHONE')) define('IDC_CONTACT_OFFICEPHONE', 1377);
if(!defined('IDC_CONTACT_PHONE')) define('IDC_CONTACT_PHONE', 1378);
if(!defined('IDC_CONTACT_FAX')) define('IDC_CONTACT_FAX', 1379);
if(!defined('IDC_CONTACT_MOBILE')) define('IDC_CONTACT_MOBILE', 1380);
if(!defined('IDC_CONTACT_EMAIL')) define('IDC_CONTACT_EMAIL', 1381);
if(!defined('IDC_CONTACT_HOMEPAGE')) define('IDC_CONTACT_HOMEPAGE', 1382);
if(!defined('IDC_CONTACT_MEMO')) define('IDC_CONTACT_MEMO', 1383);
if(!defined('IDC_CONTACT_UPDATE')) define('IDC_CONTACT_UPDATE', 1384);

// Create window

$winmain = wb_create_window($wb->mainwin, ModalDialog, "{$wb->vars["Lang"]["lang_new"]}/{$wb->vars["Lang"]["lang_edit"]} {$wb->vars["Lang"]["lang_company"]}", WBC_CENTER, WBC_CENTER, 605, 492, 0x00000001, 0);
