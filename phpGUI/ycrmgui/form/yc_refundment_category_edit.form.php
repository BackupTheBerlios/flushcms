...
wb_create_control($winmain, Label, "{$wb->vars["Lang"]["lang_category"]}{$wb->vars["Lang"]["lang_name"]}", 45, 30, 80, 15, 0, 0x00000000, 0, 0);
wb_create_control($winmain, EditBox, "", 140, 30, 130, 20, IDC_CATEGORY_NAME, 0x00000000, 0, 0);
