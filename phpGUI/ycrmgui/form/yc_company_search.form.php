...
if(!defined('IDC_KEYWORD')) define('IDC_KEYWORD', 1351);
if(!defined('IDC_SEARCH_SUBMIT')) define('IDC_SEARCH_SUBMIT', 1352);

// Create window

$search_form = wb_create_window($wb->mainwin, ModalDialog, "{$wb->vars["Lang"]["lang_search"]}{$wb->vars["Lang"]["lang_company"]}", WBC_CENTER, WBC_CENTER, 258, 118, 0x00000001, 0);
