...
if(!defined('IDC_COMPLAINTS_LIST')) define('IDC_COMPLAINTS_LIST', 2501);
if(!defined('IDC_NAV_FIRST')) define('IDC_NAV_FIRST', 2502);
if(!defined('IDC_NAV_PRE')) define('IDC_NAV_PRE', 2503);
if(!defined('IDC_NAV_NEXT')) define('IDC_NAV_NEXT', 2504);
if(!defined('IDC_NAV_LAST')) define('IDC_NAV_LAST', 2505);
if(!defined('IDC_NAV_BAR')) define('IDC_NAV_BAR', 2506);

// Insert controls

wb_create_control($maintab, ListView, "Head1,Head2,Head3,Head4", 0, 10, 625, 425, IDC_COMPLAINTS_LIST, 0x00050080, 0, 0);
