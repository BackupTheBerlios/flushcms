...
if(!defined('IDC_ORDER_CATEGORY_LIST')) define('IDC_ORDER_CATEGORY_LIST', 1901);
if(!defined('IDC_CATEGORY_NAV_FIRST')) define('IDC_CATEGORY_NAV_FIRST', 1902);
if(!defined('IDC_CATEGORY_NAV_PRE')) define('IDC_CATEGORY_NAV_PRE', 1903);
if(!defined('IDC_CATEGORY_NAV_NEXT')) define('IDC_CATEGORY_NAV_NEXT', 1904);
if(!defined('IDC_CATEGORY_NAV_LAST')) define('IDC_CATEGORY_NAV_LAST', 1905);
if(!defined('IDC_CATEGORY_NAV_BAR')) define('IDC_CATEGORY_NAV_BAR', 1906);

// Insert controls

wb_create_control($maintab, ListView, "Head1,Head2,Head3,Head4", 0, 10, 625, 425, IDC_ORDER_CATEGORY_LIST, 0x00050080, 0, 1);
