...
$wb->contact_category_list = wb_create_control($contact_tab, ListView,		"",	   0, 30,$dim[0]-10, $dim[1]-120, 	IDC_CONTACT_CATEGORY_DATA_LIST, WBC_VISIBLE | WBC_ENABLED | WBC_SORT | WBC_LINES | WBC_CHECKBOXES, 0, 1);
