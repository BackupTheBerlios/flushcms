...
if(!defined('IDC_ORDER_LIST')) define('IDC_ORDER_LIST', 1301);
...
wb_create_control($maintab, ListView, "Head1,Head2,Head3,Head4", 0, 10, 625, 425, IDC_ORDER_LIST, 0x00050080, 0, 0);
