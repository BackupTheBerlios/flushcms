...
// +----------------------------------------------------------------------+
//
// $Id: Parser.php,v 1.1 2006/12/25 05:36:38 arzen Exp $
...
/*        if (is_resource($fp)) {
 ...
 /*       }
        ...
        return false;//$this->raiseError('Illegal input format', XML_PARSER_ERROR_INVALID_INPUT);
		*/
    }
...
//        $err = &new XML_Parser_Error($msg, $ecode);
        return false;//parent::raiseError($err);
    }
