...
// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Haftanın ilk günün? kaydır";
Calendar._TT["PREV_YEAR"] = "Önceki Yıl (Men? için basıl? tutunuz)";
Calendar._TT["PREV_MONTH"] = "Önceki Ay (Men? için basıl? tutunuz)";
Calendar._TT["GO_TODAY"] = "Bugün'e git";
Calendar._TT["NEXT_MONTH"] = "Sonraki Ay (Men? için basıl? tutunuz)";
Calendar._TT["NEXT_YEAR"] = "Sonraki Yıl (Men? için basıl? tutunuz)";
