...
//$msn_menu->setMenuBox(__("管理员"));
$click_menu->setMenuSection(__("管理员"),__("添加用户"),'users/create');
$click_menu->setMenuSection(__("管理员"),__("用户列表"),'users');
$click_menu->setMenuSection(__("管理员"),__("添加权限"),'role/create');
...
$click_menu->setMenuSection(__("退出系统"),__("退出系统"),'security/logout');
