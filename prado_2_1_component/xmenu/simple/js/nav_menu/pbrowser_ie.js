...
function create_menu(l12, l13, index)
{
	...
	while (l2["item" + (this.id = l13 + this.i)])
	{
		...
		if (!this.l17)
			this.sd += "<tr>";
		this.sd += "<td> ";//<span id='"+l2["nameid" + this.id]+"'>
		...
		{
			this.sd += "<a  HREF=\""+l2["postback" + this.id]+"\" style=\"color:"+  l41(l2, "menu_items" + l9[1] + "", index)  +";text-decoration:"+l41(l2, "menu_items" + l9[6] + "", index)+"\">"+l41(l2, "item_roll", this.id, l2["item" + this.id]) + "</a></div>";
			...
			this.sd += "<a id=\""+l2["nameid" + this.id]+"\" HREF=\""+l2["postback" + this.id]+"\" style=\"color:"+  l41(l2, "menu_items" + l9[1] + "", index)  +";text-decoration:"+l41(l2, "menu_items" + l9[6] + "", index)+" \">"+l2["item" + this.id] + "</a></span> ";//</span>
		}
		else
		{
			...
			this.sd += l2["item" + this.id] + "</span> ";//</span>
		}
		// Item display end
