 ...
 * @version    CVS: $Id: ApfSelfproduct.class.php,v 1.1 2006/12/10 23:23:34 arzen Exp $
 */
...
class ApfSelfproduct  extends Actions
{
	...
	function handleFormData($edit_submit=false)
	{
		...
		$apf_selfproduct->setPhoto(stripslashes(trim($_POST['photo'])));
