...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> 'D:/workspace/APF/web/template/default/images/',												
			'text'    	=> 'Sprekers',
		),
		array (
			'value'   	=> 'D:/workspace/APF/web/template/default/images/', 				
	...
	$cfg['ilibs_dir'] 	   = array('/dev/apf/web/template/default/images/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
