<?php
/**
 * Table Definition for apf_agreement_category
 */
class DaoApfAgreementCategory extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_agreement_category';          // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfAgreementCategory',$k,$v);
	}
