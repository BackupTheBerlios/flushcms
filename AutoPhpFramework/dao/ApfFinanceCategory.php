<?php
/**
 * Table Definition for apf_finance_category
 */
class DaoApfFinanceCategory extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_finance_category';            // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfFinanceCategory',$k,$v);
	}
