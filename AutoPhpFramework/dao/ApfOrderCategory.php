<?php
/**
 * Table Definition for apf_order_category
 */
class DaoApfOrderCategory extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_order_category';              // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfOrderCategory',$k,$v);
	}
