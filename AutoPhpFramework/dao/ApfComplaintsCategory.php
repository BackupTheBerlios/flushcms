<?php
/**
 * Table Definition for apf_complaints_category
 */
class DaoApfComplaintsCategory extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_complaints_category';         // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfComplaintsCategory',$k,$v);
	}
