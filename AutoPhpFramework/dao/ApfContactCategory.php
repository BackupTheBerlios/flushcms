<?php
/**
 * Table Definition for apf_contact_category
 */
class DaoApfContactCategory extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_contact_category';            // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfContactCategory',$k,$v);
	}
