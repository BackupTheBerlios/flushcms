<?php
/**
 * Table Definition for apf_dailyreport
 */
class DaoApfDailyreport extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_dailyreport';                 // table name
    var $id;                              // int(11)  not_null primary_key auto_increment
    var $title;                           // string(60)  
    var $content;                         // blob(65535)  blob
    var $filldate;                        // datetime(19)  not_null
	...
	{
		return DB_DataObject::staticGet('DaoApfDailyreport',$k,$v);
	}
    ...
    */
    ...
    function table()
    {
         return array(
             ...
             'filldate' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_DATE + DB_DATAOBJECT_TIME + DB_DATAOBJECT_NOTNULL,
