<?php
/**
 * Table Definition for apf_company
 */
class DaoApfCompany extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_company';                     // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfCompany',$k,$v);
	}
