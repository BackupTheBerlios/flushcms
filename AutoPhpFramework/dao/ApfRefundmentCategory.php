<?php
/**
 * Table Definition for apf_refundment_category
 */
class DaoApfRefundmentCategory extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'apf_refundment_category';         // table name
	...
	{
		return DB_DataObject::staticGet('DaoApfRefundmentCategory',$k,$v);
	}
