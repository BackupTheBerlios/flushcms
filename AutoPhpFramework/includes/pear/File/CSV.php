 ...
 * @version     CVS: $Id: CSV.php,v 1.1 2006/09/27 04:54:27 arzen Exp $
 ...
 * $write = "test.csv";
 * $csv = new File_CSV;
 * $fields = array("test1","test1","test1","test1","test1","test1");
 * for($i=0;$i<6;$i++)
 * {
 * 	$csv->append($fields, $conf);
 * }
 * $csv->send($write);
