...
// +----------------------------------------------------------------------+//
// $Id: it.php,v 1.1 2006/09/20 10:05:10 arzen Exp $
...
class I18N_Common_it
{
    ...
    var $daysAbbreviated = array('Dom', 'Lun', 'Mar', 'Mer', 'Gio', 'Ven', 'Sab');

    var $monthsAbbreviated = array('Gen', 'Feb', 'Mar', 'Apr', 'Mag', 'Giu' ,'Lug', 'Ago', 'Set', 'Ott', 'Nov', 'Dic');
